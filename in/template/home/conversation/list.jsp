            ...
            <div class="middle-cont chat-cont">
                ...
                <div id="conversation-list" class="seeker-tab">
                    <c:forEach items="${conversations}" var="conversation">
                        <div class="item" data-id="${conversation.id}" data-time="<fn:formatDate value="${conversation.latest.sendDateTime}" pattern="yyyy/MM/dd HH:mm"/>">
                            <i class="state"></i>
                            <div class="avatar">
                                <img width="50" height="50" src="${conversation.company.avatar}"/>
                            </div>
                            <div class="text">
                                <p class="name">${conversation.company.nickname} · ${conversation.jobName} </p>
                ...
                <div class="chat-text">
                    <div class="chat-top-bar">
                        <div class="l-box">
                            <i class="icon icon-msg"></i>沟通中的职位:<span id="current-job"></span>
                        </div>
                        <h3>
                        ...
                        <div class="r-box">
                            <a target="_blank" id="company-info"><i class="icon icon-search"></i>查看公司信息</a>
                        </div>
                    </div>
                    <div class="cont">
