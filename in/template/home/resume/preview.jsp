...
<html>
    ...
    <body>
                        ...
                        <div id="educations-list" class="experience-list">
                            ...
                            <dl data-time="${education.graduationYear}" class="item">
                                <dt>
                                    ...
                                    <div class="company-mod"><p class="company-name school">${education.school}</p><span class="time"><span class="graduation_year">${education.graduationYear>0?education.graduationYear:"--"}</span>毕业</span></div>
        ...
        <style>
        .download-bar{height: 100px; background: #fff; box-shadow:0px 2px 5px 0px #000; position: fixed; left: 0; right: 0; bottom: 0;}
        .download-bar .btn{background:#00b38a; border-radius:3px; margin:28px auto 0px; color:#fff; display: block; width: 148px; height: 44px; line-height: 44px; text-align: center;}
        .download-bar .btn .icon{margin-right: 5px;}
        </style>
        <div class="download-bar">
            <div class="wrap">
                <a class="btn" target="_blank" href="/resume/download"><i class="icon-download icon"></i>下载简历</a>
            </div>
        </div>
